...
/obj/item/organ/internal/cyberimp/chest/serpentid_blades
	...
	action_icon = list(/datum/action/item_action/organ_action/toggle/switch_blades = 'modular_bandastation/species/serpentids/icons/organs.dmi')
	...
	var/icon_file = 'modular_bandastation/species/serpentids/icons/mob/r_serpentid.dmi'
