/datum/species/serpentid
	...
	icobase = 'modular_bandastation/species/serpentids/icons/mob/r_serpentid.dmi'
	eyes_icon = 'modular_bandastation/species/serpentids/icons/mob/r_serpentid_eyes.dmi'
	blurb = "TODO"
	language = "Stok"
	siemens_coeff = 2.0
	coldmod = 0.9
