...
#define DNA_VULPKANIN_TAIL DNA_FEATURE_BLOCKS + 3
#define DNA_VULPKANIN_TAIL_MARKINGS DNA_FEATURE_BLOCKS + 4
#define DNA_VULPKANIN_FACIAL_HAIR DNA_FEATURE_BLOCKS + 5
#define DNA_VULPKANIN_BODY_MARKINGS_COLOR DNA_FEATURE_BLOCKS + 6
#define DNA_VULPKANIN_TAIL_MARKINGS_COLOR DNA_FEATURE_BLOCKS + 7
#define DNA_VULPKANIN_HEAD_MARKINGS_COLOR DNA_FEATURE_BLOCKS + 8
#define DNA_VULPKANIN_FACIAL_HAIR_COLOR DNA_FEATURE_BLOCKS + 9

// tajaran
#define SPECIES_TAJARAN "tajaran"
#define DNA_TAJARAN_BODY_MARKINGS DNA_FEATURE_BLOCKS + 10
#define DNA_TAJARAN_HEAD_MARKINGS DNA_FEATURE_BLOCKS + 11
#define DNA_TAJARAN_TAIL DNA_FEATURE_BLOCKS + 12
#define DNA_TAJARAN_TAIL_MARKINGS DNA_FEATURE_BLOCKS + 13
#define DNA_TAJARAN_FACIAL_HAIR DNA_FEATURE_BLOCKS + 14
#define DNA_TAJARAN_BODY_MARKINGS_COLOR DNA_FEATURE_BLOCKS + 15
#define DNA_TAJARAN_HEAD_MARKINGS_COLOR DNA_FEATURE_BLOCKS + 16
#define DNA_TAJARAN_TAIL_MARKINGS_COLOR DNA_FEATURE_BLOCKS + 17
#define DNA_TAJARAN_FACIAL_HAIR_COLOR DNA_FEATURE_BLOCKS + 18

#define DNA_MODULAR_BLOCKS_COUNT 18
