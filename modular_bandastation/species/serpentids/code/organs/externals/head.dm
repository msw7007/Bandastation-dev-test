...
/obj/item/bodypart/head/carapace/replaced()
	. = ..()
	for(var/datum/action/action as anything in actions)
		action.Grant(owner)

/obj/item/bodypart/head/carapace/droplimb()
	. = ..()
	for(var/X in actions)
		var/datum/action/A = X
		A.Remove(owner)

/obj/item/bodypart/head/carapace
...
/obj/item/bodypart/head/carapace/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/carapace, FALSE, min_broken_damage)

/obj/item/bodypart/head/carapace/ui_action_click()
